...
function showMsgDiv(msg,flag,title,type,left,top,itemArray) {
	...
	if(type == 'errorMsg') {
		div = '<div id="floatMsgDiv" class="basket_panel_con" style="z-index:100000;position: absolute;width: 350px; height:100px; list-style: none; text-shadow: none;">'+		
...
function goToRetailer(temp){
	...
	if(obj.toLowerCase().indexOf("tesco")!=-1){
		window.open("http://www.tesco.com/groceries/product/search/default.aspx?searchBox=johnsons+baby&sc_cmp=tescohp_sws-1_johnsons+baby");
