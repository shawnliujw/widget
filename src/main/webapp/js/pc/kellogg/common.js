...
function showProductImage(imgUrl,sg){
	...
	//if("Y"==sg)imgUrl=oi;
	if("Y"==sg){
		var categoryName=$("li#sch_show_active").text();
		if(categoryName=='Cereals'){
			imgUrl=path+"/blowfish_images/kellogg/SpecialK2_Web_ProductGroup_Cereal.jpg";
		}else if(categoryName=='Snacks'){
			imgUrl=path+"/blowfish_images/kellogg/SpecialK2_Web_Products_P02.jpg";
		}else{
			imgUrl=oi;
		}
