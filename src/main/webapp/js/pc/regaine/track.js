...
//	_gaq.push([ "b._trackEvent", retailerName, "From Home" ]);
	var rn=retailerName=="Pharmacy"?"Pharmacy2U":retailerName;
	_gaq.push(['_trackevent', 'store choice', 'click', rn.toLowerCase() , , 'true']);
	_gaq.push(['b._trackevent', 'store choice', 'click', rn.toLowerCase() , , 'true']);
	...
	// Gender, VisitorType
	rn, // Value, for example: "Male", "Female" or "new", "engaged",
	// "customer"
