...
<script>
	$(document).ready(function() {
		...
		$(".terms_text").niceScroll({cursorcolor:"#797979",autohidemode:false,backgroundborderdisable:true});
...
<body id="Term Page" >
	<div id="BlowFishHomePage" class="blowfish_page" >
         ...
         <a href="${pageContext.request.contextPath}/${brandModel['brandName']}">
				<img src="${pageContext.request.contextPath}/images/pc/kellogg/dotter_logo.png"
				height="69" name="" border="0"> </a></div>
          <div class="clear"></div>
          <div class="terms_content">
          
     
								          <div class="terms_content_title"><h2>Dotter Terms and Policies</h2></div>
                       <div class="terms_text">
				     <div style="width: 755px; margin-right: 5px;" >			
							This page (together with the documents referred to on it) tells you the terms of use and policies for the Dotter service <b>(the Dotter service)</b>, Please read these terms of use carefully before you start to use the Dotter service. By using the Dotter service, you indicate that you accept our terms and policies. 
							<br/></br/>
							<h3>Information about us</h3>
							The Dotter service is operated by M.Pupa Ltd ("We").  We are registered in England and Wales under company number 07487210 and have our registered office at 1<sup>st</sup> Floor, New Zealand House, 80 Haymarket, London, England, SW1Y 4TE.
							<br/><br/>
							<h3>Description of the Dotter service</h3>
							The Dotter service is intended to allow you to obtain information about products and to buy products from third parties. The Dotter service will be provided on âHost Sitesâ such as a brand manufacturerâs website, Facebook page, YouTube site or any other site a brand manufacturer may use for marketing purposes . 
							<br/><br/>
							...
							<br/><br/>
							We also ensure the security of your data. We work to the highest security standards and are PCI DSS compliant â for more on PCI DSS see <a href="https://www.pcisecuritystandards.org/" target="_blank" style="color:#666666;">https://www.pcisecuritystandards.org/</a>. 
							<br/><br/>
							...
							<div style="padding-left: 15px;">
									...
									In using the Dotter service you may be required to provide us personal data such as usernames and passwords to third party retailersâ sites. In addition we may require an email address, postal address or credit card details. 
We may store your usernames to make using the Dotter service quicker to use in future, we will <b>not</b> store any other personal data.
									...
									â	Device information. For example if you are using a PC, Mobile device or tablet. <br/>
									â	Purchase information. The goods and services you purchased from retailers<br/>
									â	Log information. 
									<div style="padding-left:8px;">
									â	details of how you used our service, such as your product queries<br/>
									â	Internet protocol address<br/>
									â	device event information, such as crashes, system activity, hardware settings, browser type, browser language, the date and time of your request and referral URL<br/>
									</div>
									â	User communications. When you send email or other communications to us, we may retain those communications in order to process your enquiries, respond to your requests and improve our services.<br/>
						           </div>
						            </li>
						            </ul>
						            </div>
						...
						<br/><br/>
							...
							<div style="padding-left: 15px;">
							â	implement any personalised settings and preferences that you have indicated in the past,<br/>
							â	keep track of your activity as you use the Service<br/>
							â	take other actions designed to personalise your use of the Service and make it more convenient and efficient.
					        </div>
					        <br/>
		     ...
		     <div style="float: right; margin-right: 25px;">
		       ...
		       <div class="sch_footer" style="margin-top:23px;" >
	                       <img src="${pageContext.request.contextPath}/images/logo_dotter.png" height="18" name="" border="0">
	                       
	                       <c:if test="${fn:toLowerCase(brandModel['brandName']) == 'specialk'}">
			                      POWERED BY DOTTER IN ASSOCIATION WITH  KELLOGG'S 
	                       </c:if>
	                       <c:if test="${fn:toLowerCase(brandModel['brandName']) == 'schwartz'}">
			                      POWERED BY DOTTER IN ASSOCIATION WITH  SCHWARTZ
	                       </c:if>
	                       <c:if test="${fn:toLowerCase(brandModel['brandName']) == 'johnson baby'}">
	                       		<span style="font-size: 8px; text-decoration: none;">
			                      POWERED BY DOTTER IN ASSOCIATION WITH JOHNSON & JOHNSON</span>
	                       </c:if>
	                       <c:if test="${fn:toLowerCase(brandModel['brandName']) == 'specialk-fr'}">
	                       		<span style="font-size: 8px; text-decoration: none;">
			                      EFFECTUÃ PAR DOTTER EN ASSOCIATION AVEC KELLOGGâS</span>
	                       </c:if>
	                       | 
	                        ...
	                        <span style="color:#ffffff;">
	                        	<c:choose>
	                        		<c:when test="${fn:toLowerCase(brandModel['brandName']) == 'johnson baby'}">
	                        			<span style="font-size: 8px; text-decoration: none;">SEE TERMS</span>
	                        		</c:when>
	                        		<c:when test="${fn:toLowerCase(brandModel['brandName']) == 'specialk-fr'}">
	                        			TERMES
	                        		</c:when>
	                        		<c:otherwise>
	                        			SEE TERMS
