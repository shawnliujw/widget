...
<script src="${pageContext.request.contextPath}/js/mobile/kellogg_fr/single_product.js"></script>
<script>
	    ...
	    <div class="multi_content">
	         ...
	         <div class="multipro_con">
	               <div class="singlepro_block">
	                   <div class="multipro_img"><img src="${pageContext.request.contextPath}/images/mobile/kellogg_fr/home_pro.png" height="116px" name="" border="0"></div>
	                   <div>
			                   ...
			                   <div>
			                       <ul>
			                           <li class="single_info"><img onclick="javascript:window.history.go(-1);" src="${pageContext.request.contextPath}/images/mobile/kellogg_fr/pro_back.png" width="85px" name="" border="0"></li>
			                               ...
			                               <table width="120" height="44px;" border="0" cellspacing="0"
														...
														<tr>
															<td align="right" valign="top" style="cursor: pointer;"><img
																...
																src="${pageContext.request.contextPath}/images/mobile/kellogg_fr/btn_reduce.png"
...
<!-- 		           </div> -->
		           <div style="width:138px; float:left; height:10px; margin:12px 17px 16px 15px;">
		                  <div class="drop_menu" style="width:130px; padding-left: 8px;"  id="thisIsSingle" onclick="showDivCenter(this,'#div_s_c');">
		                       INFORMATIONS
		                  </div>
                  </div>
		                  <div id="div_s_c" style="width:138px; position: absolute; z-index: 1000; text-align: center; display: none;">
				                  <div class="drop_list" >
					                  <ul>
			                  			<li onclick="changeInfos(this,'additionalInfo');" >Informations</li>
