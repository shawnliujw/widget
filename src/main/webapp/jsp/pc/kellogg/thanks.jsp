...
<body id="Thanks Page">
	...
	<div style="margin: 0 auto;background:url(${pageContext.request.contextPath}/images/pc/kellogg/thankyou_bg.jpg); width:800px; height:600px;">
	...
	<div class="openstore_block2">
				<div class="sch_block_left">
					...
					<a href="${pageContext.request.contextPath}/${brandModel['brandName']}"><img  
							src="${pageContext.request.contextPath}/images/pc/kellogg/ths_logo.png"
	...
	<li  class="thanks_text">Your selected products have been
...
<li>
	...
	<table width="350" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="50"></td>
						<td width="60" >SHARE ON</td>
						<td width="40"><a href="#" onclick="share();">
						<img
							src="${pageContext.request.contextPath}/images/pc/kellogg/bot01.jpg"
							width="57px;" border="0"> </a>
						</td>
						
						<td width="30"></td>
						<td width="60">BACK TO</td>
						<td width="100">
						<a target="_blank" href="http://myspecialk.co.uk">
						<img
							src="${pageContext.request.contextPath}/images/pc/kellogg/bot02.jpg"
		...
		<div class="clear"></div>
   <div class="sch_footer" style="margin-top: 24px;">
