...
<body id="Term Page" >
	<div id="BlowFishHomePage" class="blowfish_page" >
         ...
         <a href="${pageContext.request.contextPath}/${brandModel['brandName']}">
				<img src="${pageContext.request.contextPath}/images/pc/schwartz/dotter_logo.png"
          ...
          <div class="terms_content">
		     ...
		     <div style="float: right; margin-right: 25px;">
		       ...
		       <div class="sch_footer">
	                       ...
	                       POWERED BY DOTTER IN ASSOCIATION WITH SCHWARTZ |  <a href="#"><span style="color:#ffffff;">SEE TERMS</span></a>
	                  </div>
   </div>
</body>
</html>