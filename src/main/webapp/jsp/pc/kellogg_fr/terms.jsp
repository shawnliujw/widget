...
<link href="${pageContext.request.contextPath}/css/main_kellogg_fr.css" rel="stylesheet" type="text/css" />
	...
	$(document).ready(function() {
		...
		//displayDefaultBasketInfo();
		 ...
		 _gaq.push(['_setAccount', '${brandModel["gaNumber"]}']);
		  ...
		  _gaq.push(['b._trackPageview','Terms']);
		  (function() {
...
piwikTracker.setDocumentTitle('Terms');
...
<body id="Term Page" >
	<div id="BlowFishHomePage" class="blowfish_page" >
         ...
         <a href="${pageContext.request.contextPath}/${brandModel['brandName']}">
				<img src="${pageContext.request.contextPath}/images/pc/kellogg_fr/dotter_logo.png"
          ...
          <div class="terms_content">
		     ...
		     <div style="float: right; margin-right: 25px;">
	                     <input class="input_btn04" style="width: 100px; margin-top:20px; " type="button" value="BACK" name="" onclick="goBack();"/>
	                  </div>
