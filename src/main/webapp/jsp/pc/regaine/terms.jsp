...
<script src="${pageContext.request.contextPath}/js/pc/regaine/common.js"></script>
</head>
<script>
...
<body id="Term Page" >
	<div id="TermsPage" style="margin: 0 auto; width: 650px; height: 600px;">
      <!--    <div class="blowfish_term_header" onClick="goBack();"> 
				<img src="${pageContext.request.contextPath}/images/pc/regaine/dotter_logo.png"
				height="69" name="" border="0"></div>
          <div class="clear"></div> -->
          <div class="terms_content">
				     ...
				     <div style="width: 605px; margin-right: 5px;" >			
							...
							<div style="padding-left: 15px;">
									...
									In using the Dotter service you may be required to provide us personal data such as usernames and passwords to third party retailers' sites. In addition we may require an email address, postal address or credit card details. 
We may store your usernames to make using the Dotter service quicker to use in future, we will <b>not</b> store any other personal data.
									...
									In using the service we may collect additional information such as:<
									</li>
									</ul>
									<ul style="list-style:disc;">
									<li>Device information. For example if you are using a PC, Mobile device or tablet.</li>
									<li>Purchase information. The goods and services you purchased from retailers.</li>
									<li>Log information. </li>
									
									<div style="padding-left:28px;">
									<ul style="list-style: circle;">
									<li>details of how you used our service, such as your product queries </li>
									...
									<li>User communications. When you send email or other communications to us, we may retain those communications in order to process your enquiries, respond to your requests and improve our services.<br/>
						            </li>
						          </ul>
						           </div>
						            </li>
						...
						<br/><br/>
							...
							<div style="padding-left: 15px;">
							<ul style="list-style:disc;">
							<li>	implement any personalised settings and preferences that you have indicated in the past,</li>
							<li>	keep track of your activity as you use the Service</li>
							<li>	take other actions designed to personalise your use of the Service and make it more convenient and efficient.
							</li>
							</ul>
					        </div>
					        <br/>
...
<!-- 	                       POWERED BY DOTTER IN ASSOCIATION WITH REGAINE | -->
<!-- 	                          <span style="color:#ffffff;">SEE TERMS</span> -->
<!-- 	                  </div> -->
   </div>
</body>
</html>